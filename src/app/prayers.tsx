    ...
    return (
        <div className="h-3/4 p-6 w-full rounded-b-3xl flex flex-col gap-4 items-center">
            <div className="flex w-full justify-between">
                <button type="button" className="text-white rotate-180 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
